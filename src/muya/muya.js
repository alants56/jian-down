import EventCenter from '@/muya/event'
import Editor from '@/muya/editor'
import Ui from '@/muya/ui'
import { BLOCK_DOM_PROPERTY, MUYA_DEFAULT_OPTIONS, CLASS_NAMES } from '@/muya/config'

import '@/muya/assets/styles/index.css'
import '@/muya/assets/styles/prismjs/light.theme.css'
import '@/muya/assets/styles/inlineSyntax.css'
import '@/muya/assets/styles/blockSyntax.css'
